...
final class LikelyKladronymDirectionTest {
  ...
  void resetsUnmatchedAbbreviation() {
    Map<String, String> addresses = Map.of(
        ...
        "автодорога Екатеринбург-Тюмень, Белоярский район, Свердловская область, Россия",
        "66007000000",
        "автодорога Волковское-Ильинское, Богдановичский район, Свердловская область, Россия",
        "66008000000",
