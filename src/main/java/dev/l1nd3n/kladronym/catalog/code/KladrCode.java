...
public final class KladrCode {
  ...
  /**
   * Returns a code with all components below the specified level set to zero. If that level has a
   * zero component, the result may identify a higher level. Requesting a level below this code's
   * rank leaves its value unchanged.
   *
  ...
  /**
   * Returns the code prefix through the specified level, inclusive, preserving leading zeros in
   * each component.
   *
  ...
  /**
   * Checks whether another code is strictly below this code in the same branch. A code does not
   * contain itself; {@link #ROOT} contains every non-root code.
   *
